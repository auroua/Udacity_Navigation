...
class DqnPixelAgent(Agent):
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = getattr(models, cfgs.MODEL_TYPE)(self.action_size, seed).to(device)
        self.qnetwork_target = getattr(models, cfgs.MODEL_TYPE)(self.action_size, seed).to(device)
    ...
    def learn(self, experiences, gamma):
        ...
        self.t_step = (self.t_step + 1)/cfgs.TARGET_EVERY
        if self.t_step == 0:
